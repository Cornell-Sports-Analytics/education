...
3. Once the ZIP file finishes downloading, locate it in your Downloads folder and extract it (either double-click on the file or right-click and select "Extract All/Unzip").
4. Inside the extracted folder, you'll find the necessary data and notebooks.
